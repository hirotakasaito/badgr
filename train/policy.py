...
class PolNetBADGRWithoutBumpy(nn.Module):
    def __init__(self, batch_size, encoder_name, is_pretrained, image_shape=(3, 224, 224), action_shape=2):
        super(PolNetBADGRWithoutBumpy,self).__init__()
        self.batch_size = batch_size
        self.input_channel = image_shape[0]
        self.input_width = image_shape[1]
        self.input_height = image_shape[2]
